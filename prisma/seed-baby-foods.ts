...
const VEGETABLES = [
  ...
  { nameKa: 'ოხრახუში',             nameEn: 'Parsnip',          minAgeMonths: 6 },
...
const SUGGESTIONS = [
  ...
  { titleKa: 'ოხრახუშის პიურე',               titleEn: 'Parsnip Puree',                 texture: 'puree',      min: 6, ing: ['ოხრახუში'] },
  ...
  { titleKa: 'ოხრახუში + სტაფილო',            titleEn: 'Parsnip & Carrot Puree',        texture: 'puree',      min: 7, ing: ['ოხრახუში', 'სტაფილო'] },
  { titleKa: 'ოხრახუში + კარტოფილი',          titleEn: 'Parsnip & Potato Puree',        texture: 'puree',      min: 7, ing: ['ოხრახუში', 'კარტოფილი'] },
