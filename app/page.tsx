...
export default async function Home() {
  ...
  const [raw, breakfast, lunch, snack, dinner, dishCount, recentBlogs, testimonials, ownTestimonial] = await Promise.all([
    ...
    prisma.dish.findFirst({ where: { mealType: 'BREAKFAST' }, orderBy: { createdAt: 'desc' }, select: { titleKa: true, titleEn: true, imageUrl: true, ingredientsKa: true, ingredientsEn: true } }),
    prisma.dish.findFirst({ where: { mealType: 'LUNCH' },     orderBy: { createdAt: 'desc' }, select: { titleKa: true, titleEn: true, imageUrl: true, ingredientsKa: true, ingredientsEn: true } }),
    prisma.dish.findFirst({ where: { mealType: 'SNACK' },     orderBy: { createdAt: 'desc' }, select: { titleKa: true, titleEn: true, imageUrl: true, ingredientsKa: true, ingredientsEn: true } }),
    prisma.dish.findFirst({ where: { mealType: 'DINNER' },    orderBy: { createdAt: 'desc' }, select: { titleKa: true, titleEn: true, imageUrl: true, ingredientsKa: true, ingredientsEn: true } }),
    prisma.dish.count(),
