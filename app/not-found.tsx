...
export default function NotFound() {
  return (
    <main className="min-h-screen bg-[#fff8f6] flex flex-col items-center justify-center px-6 text-center">
      <div className="w-24 h-24 bg-[#ff7f50]/10 rounded-full flex items-center justify-center mb-6">
        <span className="text-5xl">🍽️</span>
      </div>
      <h1 className="text-8xl font-black text-[#ff7f50] leading-none mb-2">404</h1>
      <h2 className="text-2xl font-black text-gray-900 mb-3">გვერდი ვერ მოიძებნა</h2>
