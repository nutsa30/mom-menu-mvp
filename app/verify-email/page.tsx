...
export default function VerifyEmailPage({
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#465940] px-6">
      <div className="w-full max-w-md bg-[#FDFBF0] rounded-[32px] shadow-xl p-10 text-center">
              ...
              {!resent ? (
                <>
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-[#465940]/20 focus:outline-none focus:border-[#465940] text-sm text-[#465940] bg-[#FDFBF0]"
                  />
                  <button
                    onClick={resend}
                ...
                <p className="text-[#465940] font-semibold text-sm">✓ ახალი ბმული გაიგზავნა!</p>
              )}
              <Link href="/login" className="block text-sm text-[#465940]/60 hover:text-[#465940] transition">
                ← შესვლა
              </Link>
            </div>
          </>
          ...
          <>
            ...
            {!resent ? (
              <button
                onClick={resend}
                disabled={resending || !email}
                className="text-sm text-[#465940]/50 hover:text-[#465940] transition underline"
              >
            ...
            <Link href="/login" className="block mt-4 text-sm text-[#465940]/60 hover:text-[#465940] transition">
              ← შესვლა
            </Link>
          </>
        )}
