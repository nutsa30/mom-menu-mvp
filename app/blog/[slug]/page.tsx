...
export default async function BlogPostPage({
  ...
  const articleJsonLd = {
    ...
    author: { '@type': 'Organization', name: 'mom menu', url: siteUrl },
    publisher: { '@type': 'Organization', name: 'mom menu', url: siteUrl, logo: { '@type': 'ImageObject', url: `${siteUrl}/og?title=mom+menu` } },
