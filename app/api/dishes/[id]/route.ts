  ...
  try {
    ...
    const dish = await prisma.dish.update({
      ...
      data: {
        ...
        calories: body.calories != null ? (body.calories ? Number(body.calories) : null) : undefined,
        proteinGrams: body.proteinGrams != null ? (body.proteinGrams ? Number(body.proteinGrams) : null) : undefined,
