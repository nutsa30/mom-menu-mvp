        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <a href={`/?lang=${locale}`} className="inline-block mb-4">
              <div className="leading-tight">
                <div className="text-2xl font-black text-[#F5F1E4]">mom<svg width="20" height="20" viewBox="0 0 24 24" fill="#C17D45" style={{ display: 'inline', verticalAlign: '-3px', marginLeft: '1px' }}><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg></div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {navLinks.map((l) => (
                <li key={l.href}>
                  <a href={l.href} className="text-sm text-[#F5F1E4]/75 hover:text-[#C17D45] transition">
                    {l.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-center gap-2 text-sm text-[#F5F1E4]/75">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 text-[#C17D45]">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>
                </svg>
                <a href="mailto:info@mommenu.ge" className="hover:text-[#C17D45] transition">
                  {EMAIL}
                </a>
                <button onClick={copyEmail} title={ka ? 'კოპირება' : 'Copy'}
                  className="ml-1 text-[#F5F1E4]/45 hover:text-[#C17D45] transition text-xs">
              ...
              <li className="flex items-center gap-2 text-sm text-[#F5F1E4]/75">
                ...
                <a href="tel:+995557466668" className="hover:text-[#C17D45] transition">+995 557 46 66 68</a>
              </li>
              <li className="flex items-start gap-2 text-sm text-[#F5F1E4]/75">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 text-[#C17D45] mt-0.5">
